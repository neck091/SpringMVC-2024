...
<script src="${rootPath}/static/js/gallery_input.js?2024-04-22-001"></script>
	...
	<article class="gallery">
		<f:form>
			<fieldset>
				...
				<div class="image"><img class="gallery" src="${rootPath}/static/images/noimage.png" width="100px"/></div>
