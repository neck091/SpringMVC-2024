...
public class CheckService {
    ...
    public String checkGrammar(String sentence) {
        try {
            // 문장 입력 필드 찾기
            WebElement inputField = driver.findElement(By.cssSelector(".textarea_class"));
            ...
            Thread.sleep(800); // 예시로 0.8초 대기
            WebElement resultElement = driver.findElement(By.cssSelector(
