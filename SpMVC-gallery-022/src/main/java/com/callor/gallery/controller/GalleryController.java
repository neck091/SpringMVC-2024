...
private final GalleryService galleryService;
	...
	public String insert(Model model) {
		GalleryVO galleryVO = GalleryVO.builder().g_up_image("no_image.png")
	 ...
	 * 파일을 수신하는 객체
	 * 
	 * MultipartHttpServletRequest: form의 input tag에 담겨서 전달되는 여러개의 파일을 수신하는 객체
	...
	public String insert(GalleryVO galleryVO, 
		...
		try {
			...
			/*
			 * multi file의 경우는 매개변수의 이름과는 form에서 전달한 이름은 전혀 연관이 없다. 
			 * multi 파일의 경우는 변수.getFiles() method를 실행할 때 
			 * form에서 설정한 name 속성값을 매개변수로 전달한다.
			 * 
			 */
